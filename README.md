...
| Runner image | `ghcr.io/jgruberf5/roksbnkctl-tools-runner:v1.56.0` — roksbnkctl **≥ 1.56.0 required** (terraform ≥ 1.10, helm, kubectl/oc, ibmcloud). Mirror it for air-gapped sites. |
...
| `runner.image`, `runner.tag` | runner `v1.56.0` | the roksbnkctl runner image |
